...
class Zone extends Model
{
    ...
    {
        return $this->belongsToMany(Module::class)->withPivot(['initial_fix_kms','initial_fix_km_charge','per_km_shipping_charge','minimum_shipping_charge','maximum_shipping_charge','maximum_cod_order_amount'])->using('App\Models\ModuleZone');
    }
